...
Pick from 10 models (Claude Opus 4.7, GPT-5.4 Pro, Grok 4.20, Gemini 3.1 Pro, and more), see live thinking traces when you want them, queue messages while streaming, and keep every chat session saved per notebook folder.
